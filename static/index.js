const Agent = navigator.userAgentData.mobile;
...
const createNewTab = () => {
  ts.setActiveTab(ts.addTab(new Tab()));
  ts.activeTab.getTabElement().querySelector("#invite").innerText = Agent;/*splashtext[Math.floor(Math.random() * splashtext.length)]*/
};
